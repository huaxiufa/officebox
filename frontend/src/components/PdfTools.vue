...
import { ref } from 'vue'
import { FileText, Upload, Download, Loader2, X, ShieldCheck, Scissors, Minimize2, KeyRound } from 'lucide-vue-next'
...
<template>
  <div class="pdf">
    <div class="badge">PDF WORKSPACE · v3</div>
    ...
    <div class="hint">🔐 合并加密 PDF 时填写合并密码；如果多个加密 PDF 密码不同，请先分别解密后再合并。解密不会猜测或破解密码。压缩采用 Ghostscript 实际重编码图片内容；如果压缩后反而更大，会自动保留原文件。</div>
